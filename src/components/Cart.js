...
class Cart {
    ...
    render({ cartProducts }) {
        const itemsCart = this.renderProducts(cartProducts).trim() || 'Корзина пуста.' ;
        const totalCoast = cartProducts.reduce((p, c) => p + c.price, 0);;
        ...
        CART_ELEMENT.innerHTML = (`
            <div class="cart__dialog">
                ...
                <div class="cart__total-cost">
                    <b>Общая стоимость:</b>
                    <span>${totalCoast.toLocaleString()} ₽</span>
                </div>
